...
import type { BrandSummaryDto } from '../../../common/dto/output/entity-summary.dto.ts';
import type { CategorySummaryDto } from '../../../common/dto/output/entity-summary.dto.ts';

import type { ProductDimensionsDto } from '../product-dimensions.dto.ts';
import type { VariantDimensionsDto } from '../../../variants/dto/variant-dimensions.dto.ts';
