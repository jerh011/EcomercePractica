...
import { CreateBatchBrandsResultDto } from '@ecomercepractica/shared/contracts/brands/dto/output/create-brach-brands-result.dto';
import { ListBrandsDto } from '@ecomercepractica/shared/contracts/brands/dto/output/list-brands-result.dto';

import {
  CreateBatchBrandDto,
  CreateBrandDto,
} from '@ecomercepractica/shared/contracts/brands/dto/input/create-brand.dto';
...
} from '@ecomercepractica/shared/contracts/brands/dto/input/toggle-brand.dto';
import { UpdateBrandDto } from '@ecomercepractica/shared/contracts/brands/dto/input/update-brand.dto';
import { isUuid, isValidUrl } from '@ecomercepractica/shared/validations';
...
export class BrandsService {
  ...
  private async countBrands(input: ListBrandsQueryDto): Promise<number> {
    return this.prisma.client.brand.count({
  ...
  private async getBrandById(id: string): Promise<BrandRow | null> {
    ...
    return this.prisma.client.brand.findFirst({
      where: {
        id,
        deletedAt: null,
      },
