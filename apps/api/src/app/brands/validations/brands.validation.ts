...
export function validateListBrandsQuery(value: unknown): ListBrandsQueryDto {
  ...
  return {
    ...
    before,
    query: searchQuery,
    name: optionalStringValue(query.name),
    metaTitle: optionalStringValue(query.metaTitle),
    isActive: legacyCoerceBoolean(query.isActive),
    website: optionalStringValue(query.website),
    slug: optionalStringValue(query.slug),
  };
}
