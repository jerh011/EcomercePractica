...
import { CreateBatchCategoryDto } from '@ecomercepractica/shared/contracts/categories/input/create-category.dto';
import { ListCategoriesQueryDto } from '@ecomercepractica/shared/contracts/categories/input/list-categories.dto';
import { SyncCategoryChildrenDto } from '@ecomercepractica/shared/contracts/categories/input/sync-category-children.dto';
import { UpdateCategoryDto } from '@ecomercepractica/shared/contracts/categories/input/update-category.dto';
import { CreateBatchCategoriesResultDto } from '@ecomercepractica/shared/contracts/categories/output/create-batch-categories-result.dto';
import { ListCategoriesResultDto } from '@ecomercepractica/shared/contracts/categories/output/list-categories-result.dto';
import { SyncCategoryChildrenResultDto } from '@ecomercepractica/shared/contracts/categories/output/sync-category-children-result.dto';
import {
  CategoryNode,
  CategoryRow,
  toCategoryDto,
