...
} from '@ecomercepractica/shared/contracts/products/dto/input/toggle-product.dto';
import { UpdateProductDto } from '@ecomercepractica/shared/contracts/products/dto/input/update-product.dto';
import { ListProductsResultDto } from '@ecomercepractica/shared/contracts/products/dto/output/list-products-result.dto';
import { CreateBatchProductsResultDto } from '@ecomercepractica/shared/contracts/products/dto/output/create-batch-products-result.dto';
import { ProductDto } from '@ecomercepractica/shared/contracts/products/dto/output/product.dto';
import { ProductDimensionsDto } from '@ecomercepractica/shared/contracts/products/dto/product-dimensions.dto';
    ...
    try {
      const row = (await this.prisma.client.product.create({
        data: {
          ...
          dimensionsWeight: dimensionsBase,
