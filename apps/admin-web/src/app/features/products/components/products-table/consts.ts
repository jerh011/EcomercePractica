import { PRODUCT_ACTIONS_COLUMN, PRODUCT_ACTIVE_COLUMN, PRODUCT_BASE_PRICE_COLUMN, PRODUCT_BRAND_COLUMN, PRODUCT_FEATURED_COLUMN, PRODUCT_MODEL_COLUMN, PRODUCT_NAME_COLUMN } from "@products/consts/product-columns.consts";
