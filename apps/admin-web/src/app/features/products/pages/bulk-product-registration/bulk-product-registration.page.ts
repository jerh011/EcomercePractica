...
import { attributesToProductAttributeOptions } from '@products/utils/product-attribute-option.utils';
import { brandToProductBrandOption } from '@products/utils/product-brand-option.utils';
import { categoryToProductCategoryOption } from '@products/utils/product-category-option.utils';
...
import { ProductForm } from '@products/components/forms/product-form/product-form';
import { ProductFormService } from '@products/components/forms/product-form/product-form.service';
import {
  ProductAttributeOption,
  ProductBrandOption,
  ProductCategoryOption,
  ProductFormData,
} from '@products/components/forms/product-form/types';
...
import { ProductRecord } from '@products/components/products-table/types';
import { ProductTableActionsOptions } from '@products/components/product-table-actions/types';
import {
  AdditionalAttributesSearchParams,
  CategoryAttributesSearchParams,
} from '@products/components/dialogs/register-product/types';
import { productFormDataToCreateProductRequest } from '@products/mappers/product-request.mapper';
...
@Component({
  selector: 'ecom-bulk-product-registration.page',
...
export class BulkProductRegistrationPage implements OnInit {
  ...
  private readonly productForm = viewChild(ProductForm);
