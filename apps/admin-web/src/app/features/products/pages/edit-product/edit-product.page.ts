...
} from '@products/mappers/product-request.mapper';
...
import { CursorPaginationParams, FormEvent, NoPaginationParams } from '@shared/interfaces';
import { AttributeSummary, CategorySummary, Product } from '@shared/models';
